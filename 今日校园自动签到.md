...
**提交表单我算是服了，我想偷懒，我不是人，但你是真的狗，加密就算了还套个娃！！！**

**我滴，阿里云云函数那个ide环境和控制台环境环境不一样，我琢磨半天，好不容易安装好了又跟我的log文件起冲突，差不多半天时间总算解决了**
...
[ruoli-sign-optimization](https://github.com/IceTiki/ruoli-sign-optimization.git)最后提交表单总是让我升级版本，我自己看到抓包也知道不对，就是不知道他那两数据怎么来的，还是得学学app逆向，提交表单的加密算法全是这位大佬的**感谢大佬！**
